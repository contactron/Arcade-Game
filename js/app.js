...
var Enemy = function(enemyrow) {
    var randomenemy = random(0,3);  //randomly pick an enemy type, then apply its attibutes
    ...
    this.y = (enemyrow + 1) * 83; // set row position based on passed enemyrow position.
};
